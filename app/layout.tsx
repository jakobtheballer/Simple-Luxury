  ...
  return (
    <html lang="en" className={`${geistSans.variable} h-full antialiased`}>
      <body className="min-h-full flex flex-col" style={{ fontFamily: "var(--font-geist-sans)" }}>
        ...
        {/* FOOTER */}
        <footer style={{ backgroundColor: "#0D1F2D" }} className="text-white py-10 mt-auto">
          <div className="max-w-7xl mx-auto px-8">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <a href="/" className="text-xl font-bold tracking-wide">SIMPLE LUXURY</a>
              <div className="flex flex-wrap justify-center gap-6 text-sm text-white/60">
                <a href="/fleet" className="hover:text-white transition-colors">Hütter Yachts</a>
                <a href="/fleet/all" className="hover:text-white transition-colors">Our Luxury Fleet</a>
        ...
        <a
          ...
          className="fixed bottom-6 right-6 z-50 text-white rounded-full w-16 h-16 flex items-center justify-center shadow-2xl transition-transform hover:scale-110"
